...
#define PATH(name)                      "/home/fellipegm/.local/dwmblocks/blocks/"name
...
/*      pathu                           pathc                           interval        signal */
        { PATH("calendar.sh"),          PATH("calendar_button.sh"),     30,             1},
        { PATH("cpu_p.sh"),             NULL,                           1,              2},
        { PATH("memory.sh"),            PATH("memory_button.sh"),       1,              3},
        { PATH("network.sh"),           NULL,                           1,              5},
